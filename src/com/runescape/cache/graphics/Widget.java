...
public final class Widget {
	...
	public static void load(FileArchive interfaces, GameFont textDrawingAreas[], FileArchive graphics) {
		...
		itemsKeptOnDeath2(textDrawingAreas);
	...
	public static void itemsKeptOnDeath2(GameFont[] tda) {
		...
		setBounds(5, 480, 18, 9, rsinterface);
	...
	public void specialBar(int id) // 7599
	{
		...
		rsi.type = 5;
		rsi.disabledSprite = Client.cacheSprite[191];
	...
	// spec
	{
		...
		for (int i = id2 + 3; i < id2 + 7; i++) { // 2429 - 2433
			rsi = interfaceCache[i];
			rsi.disabledSprite = Client.cacheSprite[192];
			rsi.enabledSprite = Client.cacheSprite[193];
			rsi.width = 68;
			rsi.height = 44;
		}
	}
	...
	private static void bankInterface(GameFont[] tda) {
		...
		id = 50070;
		for (int tab = 0, counter = 0; tab <= 40; tab += 4, counter++) {
		...
		//	addHoveredButton_sprite_loader(id + 2 + tab, 207, 39, 40, id + 3 + tab);
			...
			interfaceCache[id + tab].invisible = true;
